...
require(['vs/editor/editor.main'], function () {
    ...
    if (!model)	// 否则创建新的model
        model = monaco.editor.createModel(getcode(), 'MacroLang', uri);
    ...
    function bindKeyWithAction(editor, key) {
        ...
        editor.addCommand(key, function () {
            var line = editor.getPosition();  //获取选中的行信息();//editor.getValues(line.lineNumber).search(/#/) == 1
            // if (0) {
            //     pass;
            // }else {
    ...
    function getcode() {
        return ["#####延迟语法#####",
                ...
                "鼠标 左键 松开",
                "鼠标 右键 松开",
                "鼠标 左键 拖动 起点 横坐标 （算数表达式） 纵坐标 （算数表达式） 终点 横坐标 （算数表达式） 纵坐标 （算数表达式）",
                "鼠标 右键 拖动 起点 横坐标 （算数表达式） 纵坐标 （算数表达式） 终点 横坐标 （算数表达式） 纵坐标 （算数表达式）",
                "鼠标 移动到 横坐标 （算数表达式） 纵坐标 （算数表达式）",
                "鼠标 移动到 画面 （图片变量名） 图中",
                "鼠标 移动到 （图片变量名） 图的 （图片变量名） 图中",
                "鼠标 移动到 画面 （字符串） 文字中",
                "鼠标 移动到 （图片变量名） 图的 （字符串） 文字中\n\n",

                "#####键盘语法#####",
                "键盘 按下 （字符串）键 持续 （算数表达式）",
                "键盘 按下 （字符串）键",
                "键盘 松开 （字符串）键\n\n",

                "#####变量定义语法#####",
                "令 变量 （变量名） 为 画面 左上角 横坐标 （算数表达式） 纵坐标  （算数表达式） 右下角 横坐标（算数表达式）纵坐标 （算数表达式） 的数字",
                "定义 （变量类型） 变量 （变量名） 为 （...）",
                "定义 （变量类型） 变量 （变量名）",
                "令 （变量名） 为 （....）\n\n",
                ...
                "#####内置函数#####",
                "连点器 （算数表达式） 次 横坐标 （算数表达式）纵坐标 （算数表达式） 左键 间隔（算数表达式）",
                "连点器 （算数表达式） 次 横坐标（算数表达式） 纵坐标 （算数表达式） 右键 间隔 （算数表达式）",
                "等待图 （图片变量）出现"
        ].join("\n")
